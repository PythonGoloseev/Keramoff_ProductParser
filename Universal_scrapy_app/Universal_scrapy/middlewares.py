...
class SantehcentrComSpiderMiddleware:
    ...
    def process_spider_exception(self, response, exception, spider):
        UNF_STR.print_fuksi(f"---- process_spider_exception {exception}---")
...
class SantehcentrComDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
    ...
    def process_exception(self, request, exception, spider):
        spider.RaiseErrorMessage(f'Возникло исключение: {str(exception)}', request.url)
